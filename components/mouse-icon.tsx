...
// Inline SVG mouse mascot — fully transparent background so glows read cleanly
export function MouseIcon({ size = 48, className }: MouseIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path
        fill="#F4ABBA"
        d="M13.812 10.031a5.844 5.844 0 1 1-11.688 0a5.844 5.844 0 0 1 11.688 0zm20.063 0a5.844 5.844 0 1 1-11.688 0a5.844 5.844 0 0 1 11.688 0z"
      />
      <path
        fill="#99AAB5"
        d="M30 18c0 7.18-8 15-12 15S6 25.18 6 18s7-9 12-9s12 1.82 12 9z"
      />
      <path
        fill="#F4ABBA"
        d="M20.905 29.648C20.905 31.252 18.894 33 18 33c-.894 0-2.905-1.748-2.905-3.352c0-1.605 1.788-1.956 2.905-1.956c1.117 0 2.905.351 2.905 1.956z"
      />
      <g fill="#66757F">
      ...
      <path
        fill="#272B2B"
        d="M12 21s0-2 2-2s2 2 2 2v2s0 2-2 2s-2-2-2-2v-2zm8 0s0-2 2-2s2 2 2 2v2s0 2-2 2s-2-2-2-2v-2z"
      />
    </svg>
  )
}
